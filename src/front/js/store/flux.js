	...
	return {
		...
		actions: {
			...
			signUp: async (form, navigate) => {
				const url = "https://cautious-space-giggle-5xr4qgjg65ghpvj6-3001.app.github.dev/api/signup";
				await fetch(url, {
					method: "POST",
					headers: {
			...
			login: (form, navigate) => {
				...
				const url = "https://cautious-space-giggle-5xr4qgjg65ghpvj6-3001.app.github.dev/api/login";
				fetch(url, {
					method: "Post",
					headers: {
						"Content-Type": "application/json",
